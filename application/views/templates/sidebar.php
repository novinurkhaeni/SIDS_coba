            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <?php foreach ($query->result() as $value) { ?>
                        <div class="image">
                            <?php if ($value->foto == '') { ?>
                                <img src="<?php echo base_url(); ?>assets/img/pp.jpg" class="img-circle elevation-2" alt="User Image">
                            <?php } else { ?>
                                <img src="<?php echo base_url('assets/img/' . $value->foto); ?>" class="img-circle elevation-2" alt="User Image">
                            <?php } ?>
                        </div>
                    <?php } ?>
                    <div class="info">
